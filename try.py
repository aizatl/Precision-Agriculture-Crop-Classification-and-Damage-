...
img = add_bg_from_local("crop-unsplash 2.jpg")
img2 = add_bg_from_local("spencer-L3xl8e-ArtQ-unsplash.jpg")
...
if(selectDataset == "Crop Damage"):#aizatlang
    ...
    selectModel = st.sidebar.selectbox("Select Model" , options = ["Select Model", "KNN", "SVM", "Decision Tree"])
    ...
    if(selectModel == "SVM"):
        ...
        if (selectKernel == "Poly"):
            ...
            st.subheader("Please wait. Linear kernel for this dataset may take some time");
            auto_input_testing = st.checkbox("Auto Input Testing")
            manual_predict = st.checkbox("User Input Testing")
    ...
    if selectModel == "Decision Tree":
        ...
        if manual_predict:
            ...
            if st.button("Predict"):
                ...
                st.write("The predicted water level for crop is: ", predictions)
    ...
    if selectModel == "K-Nearest Neighbors":
        ...
        if selectKernel == "Poly" :
            ...
            if auto_input_testing:
                ...
                st.subheader("Linear Kernel")
                st.subheader("Please wait. Linear for this dataset may take a while")
                mselinear=  145966325.32
    ...
    if selectModel == "K-Nearest Neighbors":
        ...
        st.subheader("All kernel for this dataset may take a while to load. Please wait")
